            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="{{url('/admin/edit-role/'.$role->id)}}" method="POST" class="form-horizontal">
                                {!! csrf_field() !!}
                                ...
                                <div class="form-group{{ $errors->has('display_name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="display_name" id="displayName" placeholder="Display Name" value="{{$role->display_name}}">
                                    </div>
                                </div>
